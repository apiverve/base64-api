...
```gradle
dependencies {
    implementation 'com.github.apiverve:base64-api:1.1.14'
}
```
...
```java
import com.apiverve.base64.Base64EncoderDecoderAPIClient;
import com.apiverve.base64.APIResponse;
import com.apiverve.base64.APIException;

// Initialize the client
Base64EncoderDecoderAPIClient client = new Base64EncoderDecoderAPIClient("YOUR_API_KEY");
