# Base64 Encoder/Decoder Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:base64-api:1.1.12'
}
```
...
```java
import com.apiverve.base64.Base64Encoder/DecoderAPIClient;
import com.apiverve.base64.APIResponse;
import com.apiverve.base64.APIException;

// Initialize the client
Base64Encoder/DecoderAPIClient client = new Base64Encoder/DecoderAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/base64](https://docs.apiverve.com/ref/base64)
...
- **Documentation:** [https://docs.apiverve.com/ref/base64](https://docs.apiverve.com/ref/base64)
- **Issues:** [GitHub Issues](https://github.com/apiverve/base64-api/issues)
