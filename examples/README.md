# Base64 Encoder/Decoder API - Examples

This folder contains example code for using the Base64 Encoder/Decoder API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/base64',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/base64");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/base64](https://docs.apiverve.com/ref/base64)
