...
{
    class Base64Encoder/DecoderExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/base64";

        /// <summary>
        /// Make a GET request to the Base64 Encoder/Decoder API
        /// </summary>
        static async Task<JsonDocument> CallBase64Encoder/DecoderAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Base64 Encoder/Decoder API...\n");

            var result = await CallBase64Encoder/DecoderAPI();
