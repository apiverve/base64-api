// Package base64 provides a Go client for the Base64 Encoder/Decoder API.
//
// For more information, visit: https://apiverve.com/marketplace/base64?utm_source=go&utm_medium=readme
package base64
...
const (
	baseURL        = "https://api.apiverve.com/v1/base64"
	defaultTimeout = 30 * time.Second
)

// Client is the Base64 Encoder/Decoder API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Base64 Encoder/Decoder API client.
...
// Execute makes a request to the Base64 Encoder/Decoder API with typed parameters.
//
