...
namespace APIVerve.API.Base64EncoderDecoder
{
    ...
    /// <summary>
    /// Client for the Base64EncoderDecoder API
    /// </summary>
    public class Base64EncoderDecoderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/base64";
        ...
        public Base64EncoderDecoderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public Base64EncoderDecoderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public Base64EncoderDecoderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, Base64EncoderDecoderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(Base64EncoderDecoderQueryOptions options)
        {
        ...
        public ResponseObj Execute(Base64EncoderDecoderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(Base64EncoderDecoderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(Base64EncoderDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(Base64EncoderDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(Base64EncoderDecoderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(Base64EncoderDecoderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(Base64EncoderDecoderQueryOptions options)
        {
