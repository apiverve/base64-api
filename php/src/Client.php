...
/**
 * Client for the Base64 Encoder/Decoder API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/base64?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/base64';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\Base64Client] {$message}\n";
        }
    }
}
